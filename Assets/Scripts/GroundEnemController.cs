//Jade Lee
//This code controls the movement of the enemy on the ground (right to left)
using System.Collections;
using System.Collections.Generic;
using UnityEngine;

//Used to move each Farrow object from the right of the screen to the right 
public class GroundEnemController : MonoBehaviour
{
